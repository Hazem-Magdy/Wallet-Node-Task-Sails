...
describe('UserService', () => {
    ...
    it('should register a new user', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const result = yield authService.registerUser('zzzzz', '01007756572', '0502349611@Hossam', 'User');
    ...
    it('should not register a user with existing mobile', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const result = yield authService.registerUser('Dina', '01009756572', '0502349611@Dina', 'User');
    ...
    it('should login a user with correct credentials', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const token = yield authService.loginUser('01009756572', '0502349611@Hazem');
    ...
    it('should not login a user with incorrect credentials', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const token = yield authService.loginUser('01009751572', '0502349611@Zoz');
